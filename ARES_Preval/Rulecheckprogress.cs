...
namespace ARES_Preval
{
    public partial class Rulecheckprogress : Form, IProgressUpdate
    {
        ...
        public Point2d GetCurrentViewSize()
        {
            ...
            double h = (double)Teigha.ApplicationServices.Core.Application.GetSystemVariable("VIEWSIZE");

            //Get current view width,
            //by calculate current view's width-height ratio
            Point2d screen = (Point2d)Teigha.ApplicationServices.Core.Application.GetSystemVariable("SCREENSIZE");
